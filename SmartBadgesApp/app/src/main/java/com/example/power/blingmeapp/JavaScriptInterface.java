...
// Set up the buttons
    ...
    @JavascriptInterface
    public void createAlarmForMeeting(String title, String location, String calendarString, String colorString) throws ParseException {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity);
        if (!colorString.equals("#FFFFFF")) {
            ...
            String descriptionEventAlmostBeginning = "Reminder!  " + title + " will start in 2 minutes on " + location;
            String descriptionEventStarted = "Reminder!  " + title + " is starting on " + location;
