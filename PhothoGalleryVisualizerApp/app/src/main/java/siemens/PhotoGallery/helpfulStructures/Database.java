 ...
 //       db.delete(DatabaseHelper.TAB_USERS_GROUP, null, null);
    ...
    public void addUserAccount(UserAccount userAccount){
        ...
        if (checkUserAccount == null){
            ...
            values.put(USER_ID,userAccount.getUserID());
            values.put(USER_EMAIL,userAccount.getUserEmail());
            db.update(USER_TABLE,values, UNIQUE_KEY + "=?", new String[]{userAccount.getUserID()} );
        }
    }
    public UserAccount getUserAccount(String uniqueID){
        SQLiteDatabase db = this.getReadableDatabase();
    ...
    public void deleteAccount(String uniqueID) {
        SQLiteDatabase db = this.getWritableDatabase();
